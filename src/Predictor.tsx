...
export function Predictor(props: { model: MobileNetModel | null }) {
    ...
    const handlePredict = () => {
        ...
        if(props.model === null || blueRef.current === null)
            return;
        props.model?.predict(blueRef);
    }
    ...
    return <Card2 title={"Predict"} onUpdateTitle={(s) => ({})}>
        ...
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handlePredict}>
            Predict
        </button>
    </Card2>
}